<?php
// creating database
$link = mysqli_connect("localhost", "solopa", "q1w2e3r4");
if (mysqli_connect_errno()) {
    echo "Connect failed: %s\n", mysqli_connect_error();
    exit();
}
mysqli_query($link, "CREATE DATABASE IF NOT EXISTS eshop");
mysqli_close($link);
...
(
    ...
    status ENUM ('in progress', 'completed') DEFAULT 'in progress' NOT NULL,
...
// creating admin user root :: admin1
...
// filling up some data { some mtg cards }
...
$price = 1.99;
$colors = json_encode(array('Blue' => 1));
$img = 'http://static.starcitygames.com/sales/cardscans/MTG/AER/en/foil/BaralsExpertise.jpg';
